...
CREATE TABLE `cliente` (
  ...
  `Cliente_Apellido_Paterno` varchar(20) NOT NULL,
  `Cliente_Apellido_Materno` varchar(20) DEFAULT NULL,
  `Cliente_Email` varchar(50) NOT NULL,
  `Cliente_Contra` varchar(30) NOT NULL,
  `Cliente_img` blob NOT NULL,
  `Cliente_Calle` varchar(30) NOT NULL,
  `Cliente_colonia` varchar(30) NOT NULL,
  ...
  CONSTRAINT `cliente_ibfk_1` FOREIGN KEY (`Administrador_Id`) REFERENCES `administrador` (`Administrador_Id`)
