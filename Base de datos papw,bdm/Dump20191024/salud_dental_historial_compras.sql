...
CREATE TABLE `historial_compras` (
  ...
  `Historial_Precio_producto` int(11) NOT NULL,
  `Historial_Unidades_producto` int(11) NOT NULL,
  `Historial_total` int(11) NOT NULL,
  `Cliente_Id` int(11) NOT NULL,
  `Producto_Id` int(11) NOT NULL,
  PRIMARY KEY (`Historial_Id`),
  KEY `Cliente_Id` (`Cliente_Id`),
  KEY `Producto_Id` (`Producto_Id`),
  CONSTRAINT `historial_compras_ibfk_1` FOREIGN KEY (`Cliente_Id`) REFERENCES `cliente` (`Cliente_Id`),
  CONSTRAINT `historial_compras_ibfk_2` FOREIGN KEY (`Producto_Id`) REFERENCES `producto` (`Producto_Id`)
