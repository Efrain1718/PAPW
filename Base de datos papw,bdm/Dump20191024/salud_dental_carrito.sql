...
CREATE TABLE `carrito` (
  ...
  `Carrito_Precio_producto` int(11) NOT NULL,
  `Carrito_Unidades_producto` int(11) NOT NULL,
  `Carrito_total` int(11) NOT NULL,
  ...
  CONSTRAINT `carrito_ibfk_2` FOREIGN KEY (`Producto_Id`) REFERENCES `producto` (`Producto_Id`)
